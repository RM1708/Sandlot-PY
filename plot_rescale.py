...
image_rescaled = rescale(image, 1.0 / 16.0, anti_aliasing=False)
...
print("rescaled image.shape: ", image_rescaled.shape)
print("resized image.shape: ", image_resized.shape)
print("downscaled image.shape: ", image_downscaled.shape)
